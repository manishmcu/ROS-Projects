...
int main(int argc, char **argv)
{
	...
	ros::NodeHandle n;  // this Node_Handle will be use to creat publisher & subscriber both...

	//create a publisher with a topic "chatter" that will send a String message
	ros::Publisher chatter_publisher = n.advertise<std_msgs::String>("chatter", 1000);/*"chatter"->Common topic,1000-buffer_size
    buffer_size-- upto 1000 msgs will carry */ 
